...
{
    UIAlertView* dialog = [[UIAlertView alloc] initWithTitle:@"Enter Group Name" message:@"To Share" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Add", nil];
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex == 1)
    {
        ...
        {
            UIAlertView *errorAlertView = [[UIAlertView alloc] initWithTitle:@"No Group Name" message:@"Please type in a name." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
            [errorAlertView show];
